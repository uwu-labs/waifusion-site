      ...
      >
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <div className="flex items-center justify-center gap-5 mt-6">
            ...
            <Link href="https://x.com/bykusari" target="_blank" className="text-gray-700 hover:text-gray-900" aria-label="X">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
            </Link>
            <Link href="https://farcaster.xyz/bykusari" target="_blank" className="text-gray-700 hover:text-gray-900" aria-label="Farcaster">
            ...
            <Link href="https://instagram.com/bykusari" target="_blank" className="text-gray-700 hover:text-gray-900" aria-label="Instagram">
