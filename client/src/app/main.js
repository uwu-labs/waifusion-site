...
import { Flex, QR, Button, Text, Box, Loader, left } from "rimble-ui";
              ...
              >
                <center className="waifu-pic-box-center waifu-card-pink-center">
                  ...
                  <span className="card-box-center-pink-text test-margin">
                    ...
                    <span className="waifu-box-number">{item.id}
                    <svg style={{height:'2vh', marginLeft:'1vw'}} aria-hidden="true" focusable="false" data-prefix="far" data-icon="copy" role="img" viewBox="0 0 448 512" className="svg-inline--fa fa-copy fa-w-14 fa-2x"
