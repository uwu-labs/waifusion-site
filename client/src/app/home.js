    ...
    return (
        <>  
                ...
                <div className="box-upper">
                    ...
                    <Box className="waifu-card-box-pink-sub waifu-pic-box waifu-card-sub-black" color="white" style={{maxWidth:1424, marginBottom:1}}>
                        <center className="waifu-pic-box-center waifu-card-pink-center">
                            <span className="card-box-center-pink-text">Waifu Name #6969</span>
                            <img className="waifu-dotted-line" src={WaifuDottedLine}/>
                                <img className="waifu-focus-text" src={FocusText}/>
                                <img className="waifu-card-image" src={GLOBALS.DEFAULT_WAIFU_IMAGE}/>
                                <br/>
                ...
                <div className="green-sub-box">
                    ...
                    <Box className="waifu-card-box-sub" color="white" style={{maxWidth:1424, marginBottom:1}}>
                        <center className="waifu-card-box-center">
                            ...
                            <br/>
                            <div className="waifu-card-text waifu-about-text" >Waifusion is a digital Waifu collection.
                            There
                            are 16,384 guaranteed-unique Waifusion NFTs. They’re just like you; a beautiful work of art, but 2-D and
                            therefore, superior, Anon-kun.
                            <br/>
                            <br/>
                            Waifusions are randomly and fairly distributed on-chain which means they don’t like it when perverts try to
                            add
                            too many Waifus to their harem. Be faithful to your Waifus and only buy a max of 20 at once for your harem!
                            <br/>
                            <br/>
                            Each Waifu is wholly unique and yours forever... unless you sell them... Baka.
                            <br/>
                            <br/>
                            *25% of the Waifusion BSC sale will be shared with people who buy at least 20 waifus in this sale. This will happen when BSC sells out or 14 days have elapsed whichever comes first.*
                            <br/>
                            <br/>
                            <div class="waifu-card-header-text">Get Your Waifus WET?</div>
                            <br/>
                            <br/>
                            ...
                            <Box>
                                <Flex className="about-buttons-container">
                                    <Box style={{paddingRight:'25px'}}>
                                        <Link to="/overview"><Button.Outline className="waifu-card-buttons"><span className="waifu-button-learnmore"> Learn MORE</span> </Button.Outline></Link>
                                    </Box>
                                    <Box>
                                        <Button.Outline className="waifu-card-buttons" onClick={openBuyModal}><span className="waifu-button-learnmore"> Buy WAIFU</span> </Button.Outline>
                                    </Box>
                                </Flex>
                            </Box>
                        </center>
            ...
            <Box className="waifu-presale-container">
             ...
             <div className="box-upper">
                 <img src={OverviewGreenBar} className="waifu-card-box-greenbar"/>
                 <Box className="waifu-card-box-presale-sub" color="white" style={{maxWidth:1000, marginBottom:1}}>
                     <center className="waifu-card-box-center">
                         <div className="presale-title">Presale</div>
                         {/* First Presale Row */}
                         <Flex  className="presale-progress">
                            <Box>
                                <span className={`eth-sale-text presale-svg ${homeStore.progressArray.length==1? "colored-pending":""} ${homeStore.progressArray.length>1?"color-completed":""}`}>0.1 ETH</span>
                                <br/>
                                <svg className={`presale-svg ${homeStore.progressArray.length==1 ? "colored-pending" : ""} ${homeStore.progressArray.length > 1?"colored-completed": ""} ${homeStore.progressArray.length<1 ? "colored-unavailable" : ""}`} 
                                    width="215" height="32" viewBox="0 0 215 32" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span className="eth-sale-text presale-svg colored-unavailable">1500</span>
                                <br/>
                                <span className="eth-sale-text presale-svg colored-unavailable">WAIFUS</span> 
                            </Box>
                            <Box>
                                <span className="eth-sale-text presale-svg">0.2 ETH</span>
                                <br/>
                                <svg className={`presale-svg ${homeStore.progressArray.length==2 ? "colored-pending" : ""} ${homeStore.progressArray.length > 2?"colored-completed": ""} ${homeStore.progressArray.length<2 ? "colored-unavailable" : ""}`} width="215" height="32" viewBox="0 0 215 32" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M130.999 18.7234H164.999V22.7234H130.999V18.7234Z" />
                                    <path d="M130.999 8.72339H164.999V12.7234H130.999V8.72339Z" />
                                    <path d="M186.231 0.000976562L203.231 29.4458L199.767 31.4459L182.767 2.00098L186.231 0.000976562Z" />
                                    <path d="M197.464 0.000976562L214.464 29.4458L210.999 31.4459L193.999 2.00098L197.464 0.000976562Z" />
                            ...
                            <Box>
                                ...
                                <br/>
                                <svg className={`presale-svg ${homeStore.progressArray.length==3 ? "colored-pending" : ""} ${homeStore.progressArray.length > 3?"colored-completed": ""} ${homeStore.progressArray.length<3 ? "colored-unavailable" : ""}`} width="215" height="32" viewBox="0 0 215 32" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M130.999 18.7234H164.999V22.7234H130.999V18.7234Z" />
                                    <path d="M130.999 8.72339H164.999V12.7234H130.999V8.72339Z" />
                                    <path d="M186.231 0.000976562L203.231 29.4458L199.767 31.4459L182.767 2.00098L186.231 0.000976562Z" />
                                    <path d="M197.464 0.000976562L214.464 29.4458L210.999 31.4459L193.999 2.00098L197.464 0.000976562Z" />
                                ...
                                <span className="eth-sale-text presale-svg colored-unavailable">2000</span>
                                <br/>
                                <span className="eth-sale-text presale-svg colored-unavailable">WAIFUS</span>
                            </Box>
                            <Box>
                                ...
                                <br/>
                                <svg className={`presale-svg ${homeStore.progressArray.length==4 ? "colored-pending" : ""} ${homeStore.progressArray.length > 4?"colored-completed": ""} ${homeStore.progressArray.length<4 ? "colored-unavailable" : ""}`} width="215" height="32" viewBox="0 0 215 32" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M130.999 18.7234H164.999V22.7234H130.999V18.7234Z" />
                                    <path d="M130.999 8.72339H164.999V12.7234H130.999V8.72339Z" />
                                    <path d="M186.231 0.000976562L203.231 29.4458L199.767 31.4459L182.767 2.00098L186.231 0.000976562Z" />
                                    <path d="M197.464 0.000976562L214.464 29.4458L210.999 31.4459L193.999 2.00098L197.464 0.000976562Z" />
                            ...
                            <Box>
                                ...
                                <br/>
                                <svg className={`presale-svg ${homeStore.progressArray.length==5 ? "colored-pending" : ""} ${homeStore.progressArray.length > 5?"colored-completed": ""} ${homeStore.progressArray.length<5 ? "colored-unavailable" : ""}`} width="215" height="32" viewBox="0 0 215 32" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M130.999 18.7234H164.999V22.7234H130.999V18.7234Z" />
                                    <path d="M130.999 8.72339H164.999V12.7234H130.999V8.72339Z" />
                                    <path d="M186.231 0.000976562L203.231 29.4458L199.767 31.4459L182.767 2.00098L186.231 0.000976562Z" />
                                    <path d="M197.464 0.000976562L214.464 29.4458L210.999 31.4459L193.999 2.00098L197.464 0.000976562Z" />
                        ...
                        <Box>
                            ...
                            <br/>
                            <svg className={`presale-svg ${homeStore.progressArray.length==6 ? "colored-pending" : ""} ${homeStore.progressArray.length > 6?"colored-completed": ""} ${homeStore.progressArray.length<6 ? "colored-unavailable" : ""}`} width="215" height="32" viewBox="0 0 215 32" xmlns="http://www.w3.org/2000/svg">
                                <path d="M130.999 18.7234H164.999V22.7234H130.999V18.7234Z" />
                                <path d="M130.999 8.72339H164.999V12.7234H130.999V8.72339Z" />
                                <path d="M186.231 0.000976562L203.231 29.4458L199.767 31.4459L182.767 2.00098L186.231 0.000976562Z" />
                                <path d="M197.464 0.000976562L214.464 29.4458L210.999 31.4459L193.999 2.00098L197.464 0.000976562Z" />
                        ...
                        <Box>
                            ...
                            <br/>
                            <svg className={`presale-svg ${homeStore.progressArray.length==7 ? "colored-pending" : ""} ${homeStore.progressArray.length > 7?"colored-completed": ""} ${homeStore.progressArray.length<7 ? "colored-unavailable" : ""}`} width="215" height="32" viewBox="0 0 215 32" xmlns="http://www.w3.org/2000/svg">
                                <path d="M130.999 18.7234H164.999V22.7234H130.999V18.7234Z" />
                                <path d="M130.999 8.72339H164.999V12.7234H130.999V8.72339Z" />
                                <path d="M186.231 0.000976562L203.231 29.4458L199.767 31.4459L182.767 2.00098L186.231 0.000976562Z" />
                                <path d="M197.464 0.000976562L214.464 29.4458L210.999 31.4459L193.999 2.00098L197.464 0.000976562Z" />
                        ...
                        <Box>
                            ...
                            <br/>
                            <svg className={`presale-svg ${homeStore.progressArray.length==8 ? "colored-pending" : ""} ${homeStore.progressArray.length > 8?"colored-completed": ""} ${homeStore.progressArray.length<8 ? "colored-unavailable" : ""}`} width="215" height="32" viewBox="0 0 215 32" xmlns="http://www.w3.org/2000/svg">
                                <path d="M130.999 18.7234H164.999V22.7234H130.999V18.7234Z" />
                                <path d="M130.999 8.72339H164.999V12.7234H130.999V8.72339Z" />
                                <path d="M186.231 0.000976562L203.231 29.4458L199.767 31.4459L182.767 2.00098L186.231 0.000976562Z" />
                                <path d="M197.464 0.000976562L214.464 29.4458L210.999 31.4459L193.999 2.00098L197.464 0.000976562Z" />
                        ...
                        <Box>
                            ...
                            <br/>
                            <svg className={`presale-svg ${homeStore.progressArray.length==9 ? "colored-pending" : ""} ${homeStore.progressArray.length > 9?"colored-completed": ""} ${homeStore.progressArray.length<9 ? "colored-unavailable" : ""}`} width="215" height="32" viewBox="0 0 215 32" xmlns="http://www.w3.org/2000/svg">
                                <path d="M130.999 18.7234H164.999V22.7234H130.999V18.7234Z" />
                                <path d="M130.999 8.72339H164.999V12.7234H130.999V8.72339Z" />
                                <path d="M186.231 0.000976562L203.231 29.4458L199.767 31.4459L182.767 2.00098L186.231 0.000976562Z" />
                                <path d="M197.464 0.000976562L214.464 29.4458L210.999 31.4459L193.999 2.00098L197.464 0.000976562Z" />
                            ...
                            <span className="eth-sale-text presale-svg colored-unavailable">1000</span>
                            <br/>
                            <span className="eth-sale-text presale-svg colored-unavailable">WAIFUS</span>
                        </Box>
                        <Box>
                            ...
                            <br/>
                            <svg className={`presale-svg ${homeStore.progressArray.length==10 ? "colored-pending" : ""} ${homeStore.progressArray.length > 10?"colored-completed": ""} ${homeStore.progressArray.length<10 ? "colored-unavailable" : ""}`} width="215" height="32" viewBox="0 0 215 32" xmlns="http://www.w3.org/2000/svg">
                                <path d="M130.999 18.7234H164.999V22.7234H130.999V18.7234Z" />
                                <path d="M130.999 8.72339H164.999V12.7234H130.999V8.72339Z" />
                                <path d="M186.231 0.000976562L203.231 29.4458L199.767 31.4459L182.767 2.00098L186.231 0.000976562Z" />
                                <path d="M197.464 0.000976562L214.464 29.4458L210.999 31.4459L193.999 2.00098L197.464 0.000976562Z" />
                            ...
                            <br/>
                            <span className="eth-sale-text presale-svg colored-unavailable">381</span>
                            <br/>
                            <span className="eth-sale-text presale-svg colored-unavailable">WAIFUS</span>
                        </Box>
                    </Flex>
                    <Box className="presale-progress">
                            ...
                            <br/>
                            <svg className={`${homeStore.progressArray.length==11 ? "colored-pending" : ""} ${homeStore.progressArray.length > 11?"colored-completed": ""} ${homeStore.progressArray.length<11 ? "colored-unavailable" : ""}`} width="215" height="32" viewBox="0 0 215 32" xmlns="http://www.w3.org/2000/svg">
                                <path d="M130.999 18.7234H164.999V22.7234H130.999V18.7234Z" />
                                <path d="M130.999 8.72339H164.999V12.7234H130.999V8.72339Z" />
                                <path d="M186.231 0.000976562L203.231 29.4458L199.767 31.4459L182.767 2.00098L186.231 0.000976562Z" />
                                <path d="M197.464 0.000976562L214.464 29.4458L210.999 31.4459L193.999 2.00098L197.464 0.000976562Z" />
                            ...
                            <br/>
                            <span className="eth-sale-text  colored-unavailable">WAIFUS</span>
                    </Box>
                    <br/>
                        <Button.Outline className="waifu-card-buttons" onClick={openBuyModal}><span className="waifu-button-learnmore"> Buy WAIFU</span> </Button.Outline>
                     </center>
                        ...
                        <div className="box-upper">
                            ...
                            <Box className="waifu-card-box-presale-sub" color="white" style={{maxWidth:1000, marginBottom:1}}>
                                <center className="waifu-card-box-center">
                                    ...
                                    <Input className="waifu-input" type="number" placeholder="How Many?" min="0" max="20" value = {homeStore.purchaseQuantity} onChange={(event)=>{
                                        console.log("Event: " + event.target.value);
                                        homeStore.updatePurchaseQuantity(event.target.value);}}></Input>
                                    <Text className="modal-main-text">You can buy up to 20 per transaction</Text>
                                    <Text className="modal-error-text">{homeStore.validationResults}</Text>
                                    <br/>
                                    <Box className="modal-button-container">
                                        <Button.Outline className="modal-buttons" onClick={closeBuyModal}><span className="waifu-button-learnmore"> Cancel</span> </Button.Outline>
                                        <Button.Outline className="modal-buttons" onClick={validatePurchase}><span className="waifu-button-learnmore" > Purchase</span> </Button.Outline>
                                    </Box>
                                </center>
                            </Box>
                        </div>
