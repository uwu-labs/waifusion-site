...
import { Input, Blockie, Card, Flex, Heading, Button, Text, Box, Select, Field, Modal } from 'rimble-ui';
import styled, { keyframes } from 'styled-components'

import Window from "../assets/Window.svg";
import Logo from "../assets/Logo.svg";
import IconBoxes from "../assets/icon_boxes.svg";
import PixGradient from "../assets/pixelated_gradient.svg";

import SplashLayout from '../components/splashlayout';
import SEO from '../components/seo';
//<PixGradient  position="absolute" style={{zIndex:'1'}}/>
// <IconBoxes position="absolute"  style={{zIndex:'2'}}/>

import  '../components/layout.css';
import bg from '../assets/a289d59e1e6afaf935e7d7c1fb652501.gif.mp4';
import VideoBg from "reactjs-videobg";
import VT323 from '@fontsource/vt323/index.css';
...
const SplashPage = () => {
    ...
    useEffect(() => {
        ...
        async function showWindow() {
            ...
            setInterval(() => {setShowWindow(true)}, 2000);
        };
        showWindow();
    }, [])
