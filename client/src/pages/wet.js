      ...
      <div className="box-upper">
        ...
        >
          <center className="waifu-card-box-center">
            ...
            <br />
            <div className="waifu-card-text waifu-about-text">
              Each year, approximately 3,660 WETs will drip off each Waifu.
              After 10 years, the emission of new WETs comes to a halt. From
              then on, WETs can only be boiled until no Waifus are WET anymore
              (Ben Shapiro is a prophet) and the names of the Waifus cannot be
